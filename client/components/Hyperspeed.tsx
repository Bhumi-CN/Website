...
const Orb: FC<OrbProps> = ({ hoverIntensity, rotateOnHover, hue, forceHoverState }) => {
  // For now, ignore the props and just render Hyperspeed with default options
  return <Hyperspeed effectOptions={{}} />;
};
